...
export function mapWarehouseApi(warehouse: WarehouseApi): Warehouse {
  return {
    ...
    code: warehouse.code,
    name: warehouse.name,
    locationDisplayName: warehouse.location_display_name,
    locationStreet: warehouse.location_street,
    locationHouseNumber: warehouse.location_house_number,
    locationPostcode: warehouse.location_postcode,
    locationCity: warehouse.location_city,
    locationState: warehouse.location_state,
    locationCountry: warehouse.location_country,
    locationLat: warehouse.location_lat,
    locationLon: warehouse.location_lon,
    locationSource: warehouse.location_source,
    locationSourceId: warehouse.location_source_id,
